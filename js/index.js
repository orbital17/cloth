...
(function() {
  ...
  Vector3D = (function() {
    ...
    Vector3D.prototype.normalize = function() {
      var norm;
      norm = Math.sqrt(this.coords[0] * this.coords[0] + this.coords[1] * this.coords[1] + this.coords[2] * this.coords[2]);
      return this.multByNumber(1.0 / norm);
    };
  ...
  Cloth = (function() {
    ...
    function Cloth(width, height, block_size) {
      ...
      this.m = 1.0 / (this.height * this.width);
    ...
    Cloth.prototype.hookeForce = function(i, j) {};

    Cloth.prototype.hookeForce_spring = function(i, j, _i, _j) {
      var k, l, sum;
      ...
      return this.state[j][i].vectorTo(this.state[_j][_i]).subtructNumber(l).multByNumber(k / l);
    };
